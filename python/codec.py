...
audio_codec = subprocess.check_output("/DATA/reference_library/ffmpeg-git-20171128-64bit-static/ffprobe -v quiet -show_streams -select_streams a '/DATA/reference/ani/[2009]메리와 맥스 Mary.And.Max/Mary.And.Max 2009.720p.BRRip.XviD-Power.mkv' | grep 'codec_name='",shell=True)
